...
class qtype_ordering_edit_form extends question_edit_form {
    ...
    public function definition_inner($mform): void {
        ...
        $mform->setDefault('gradingtype', $this->get_default_value('gradingtype', qtype_ordering_question::GRADING_ABSOLUTE_POSITION));
        ...
        $mform->setDefault('numberingstyle', $this->get_default_value('numberingstyle', qtype_ordering_question::NUMBERING_STYLE_DEFAULT));
