...
final class questiontype_test extends \question_testcase {
    ...
    public function test_xml_import_empty(): void {
        // See https://tracker.moodle.org/browse/MDL-79863?focusedId=1063119&page=com.atlassian.jira.plugin.system.issuetabpanels%3Acomment-tabpanel#comment-1063119 item#18.
        ...
        self::expectedimport()->name = 'Put these words in order.';
