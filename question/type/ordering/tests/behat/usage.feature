...
Feature: Complete an Ordering question attempt
  ...
  @javascript
  Scenario Outline: As a student I can answer the question correctly and see differently list styling.
    ...
    And the following should exist in the "user-grades" table:
      | -1-       | -1-                  | -3-    |
      | Student 1 | student1@example.com | 100.00 |
    Examples:
      | question     | styling        |
      | ordering-001 | .numberingnone |
      | ordering-002 | .numberingabc  |
      | ordering-003 | .numberingABCD |
      | ordering-004 | .numbering123  |
      | ordering-005 | .numberingiii  |
      | ordering-006 | .numberingIIII |
      | ordering-007 | .numberingabc  |
      | ordering-008 | .numberingabc  |
  ...
  Scenario Outline: As a student I can partially answer the question and get different grades and feedback.
    ...
    Examples:
      | question     | state             | mark                  | grade | expect  | gradedetails   | correct          | partial                    |  incorrect         | type                                         |
      | ordering-001 | Incorrect         | Mark 0.00 out of 2.00 | 0.00  | see     | 6 = 33%        |                  |                            |                    | All or nothing                               |
      | ordering-002 | Partially correct | Mark 0.40 out of 2.00 | 20.00 | not see | Grade details: | Correct items: 1 |                            | Incorrect items: 4 | Absolute position                            |
      | ordering-003 | Partially correct | Mark 0.33 out of 2.00 | 16.67 | see     | 6 = 17%        | Correct items: 1 |                            | Incorrect items: 5 | Relative to the next item (including last)   |
      | ordering-004 | Partially correct | Mark 0.33 out of 2.00 | 16.67 | not see | Grade details: |                  | Partially correct items: 2 | Incorrect items: 4 | Relative to the next item (excluding last)   |
      | ordering-005 | Partially correct | Mark 0.13 out of 2.00 | 6.67  | see     | 30 = 7%        |                  | Partially correct items: 2 | Incorrect items: 4 | Relative to ALL the previous and next items  |
      | ordering-006 | Partially correct | Mark 0.67 out of 2.00 | 33.33 | not see | Grade details: | Correct items: 2 |                            | Incorrect items: 4 | Relative to both the previous and next items |
      | ordering-007 | Partially correct | Mark 0.67 out of 2.00 | 33.33 | see     | 6 = 33%        | Correct items: 2 |                            | Incorrect items: 4 | Longest contiguous subset                    |
      | ordering-008 | Partially correct | Mark 0.93 out of 2.00 | 46.67 | not see | Grade details: | Correct items: 2 | Partially correct items: 2 | Incorrect items: 2 | Longest ordered subset                       |

  @javascript
  Scenario Outline: As a student I can incorrectly answer the question and get different feedback.
    Given quiz "Quiz 1" contains the following questions:
      | question   | page | maxmark |
      | <question> | 1    | 2.00    |
    And I am on the "Quiz 1" "quiz activity" page logged in as "student1"
    When I click on "Attempt quiz" "button"
    And I wait until the page is ready
    # DnD the items in the incorrect order and then submit.
    And I drag "Environment" to space "1" in the ordering question
    And I drag "Learning" to space "2" in the ordering question
    ...
    And the following should exist in the "user-grades" table:
      ...
      | Student 1 | student1@example.com | <grade> |
    Examples:
      | question     | state             | mark                  | grade  | expect  | gradedetails              | partial                    | incorrect                 | type                                         |
      | ordering-001 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | see     | That is not right at all. |                            |                           | All or nothing                               |
      | ordering-002 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | not see | Grade details:            |                            | That is not right at all. | Absolute position                            |
      | ordering-003 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | see     | That is not right at all. |                            |                           | Relative to the next item (including last)   |
      | ordering-004 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | not see | Grade details:            |                            | That is not right at all. | Relative to the next item (excluding last)   |
      | ordering-005 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | see     | That is not right at all. |                            |                           | Relative to ALL the previous and next items  |
      | ordering-006 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | not see | Grade details:            |                            | That is not right at all. | Relative to both the previous and next items |
      | ordering-007 | Incorrect         | Mark 0.00 out of 2.00 | 0.00   | see     | That is not right at all. |                            |                           | Longest contiguous subset                    |
      | ordering-008 | Partially correct | Mark 0.80 out of 2.00 | 40.00  | not see | Grade details:            | Partially correct items: 4 | Incorrect items: 2        | Longest ordered subset                       |
