...
Feature: I can grade a students interaction across a forum
  ...
  Using rubric based advanced grading
  ...
  Scenario: Test setting up forum grading and test some of the basic functionality.
    ...
    And I set the following fields to these values:
      ...
      | Whole forum grading > Grading method | Rubric                |
    And I press "Save and display"

    When I go to "Rubric Forum" advanced grading definition page
    # Defining a rubric.
    And I set the following fields to these values:
