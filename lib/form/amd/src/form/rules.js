...
export default class Rules {
     ...
     */
    notchecked(target) {
        // TODO: Refinement || Simplification || Documentation of always calling the template in each rule.
    ...
    eq(target) {
        ...
        this.form.getDependantsOfType(target.name, 'eq').forEach((dependant, key) => {
            // TODO: Refinement || Simplification || Documentation the different input types?
