...
function print_textarea() {
    throw new coding_exception(
        'print_textarea() is deprecated. Please use $OUTPUT->print_textarea() instead.'
    );
}
...
function calendar_get_all_allowed_types() {
    throw new coding_exception(
        'calendar_get_all_allowed_types() is deprecated. Please use calendar_get_allowed_types() instead.'
    );
...
function groups_get_all_groups_for_courses() {
    throw new coding_exception(
        'groups_get_all_groups_for_courses() is deprecated and can not be used anymore.'
    );
}
...
function message_add_contact() {
    throw new coding_exception(
        'message_add_contact() is deprecated. Please use \core_message\api::create_contact_request() instead. ' .
...
function message_remove_contact() {
    throw new coding_exception(
        'message_remove_contact() is deprecated. Please use \core_message\api::remove_contact() instead.'
    );
}
...
function message_unblock_contact() {
    throw new coding_exception(
        'message_unblock_contact() is deprecated. Please use \core_message\api::unblock_user() instead.'
    );
}
...
function message_block_contact() {
    throw new coding_exception(
        'message_block_contact() is deprecated. Please use \core_message\api::is_blocked() and ' .
...
function message_get_contact() {
    throw new coding_exception(
        'message_get_contact() is deprecated. Please use \core_message\api::get_contact() instead.'
    );
}
