...
$string['enablemoodlenet'] = 'Enable integration with MoodleNet sites';
$string['enablemoodlenet_help'] = 'If enabled, and provided the MoodleNet plugin is installed, users can import content from MoodleNet into Moodle.';
