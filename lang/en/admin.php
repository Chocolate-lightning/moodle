...
$string['defaultmoodlenet'] = "Default MoodleNet instance";
$string['defaultmoodlenet_desc'] = "A link to the default MoodleNet instance is provided in the Activity chooser in each course, together with the option to connect to and browse a local MoodleNet instance.";
