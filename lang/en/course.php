...
$string['aria:selectfavouritestab'] = 'Open the favourites modules tab';
$string['aria:selectrecommendedtab'] = 'Open the recommended modules tab';
$string['aria:selectdefaulttab'] = 'Open the default modules tab';
$string['aria:modulefavourite'] = 'Module is starred';
$string['aria:selectfavouritestab'] = 'Open the favourites modules tab';
$string['aria:selectrecommendedtab'] = 'Open the recommended modules tab';
$string['aria:selectdefaulttab'] = 'Open the default modules tab';
...
$string['favouritetoggle'] = 'Toggle favourite status of the {$a} activity';
...
$string['modulefavourite'] = 'Starred module';
$string['navigatemoduletabs'] = 'Navigate between module tabs';
...
$string['privacy:metadata:activityfavouritessummary'] = 'The course system contains favourite information about the activity chooser and which activities have been favourited.';
