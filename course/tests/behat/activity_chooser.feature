...
Feature: Display and choose from the available activities in course
  ...
  Scenario: Favourite a module in the activity chooser
    ...
    When I click on "Information about the Assignment activity" "button" in the "favourites" "core_course > Activity chooser tab"
    Then I should see "The assignment activity module enables a teacher to communicate tasks, collect work and provide grades and feedback."
