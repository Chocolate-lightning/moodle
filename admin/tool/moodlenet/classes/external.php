...
class external extends external_api {
    ...
    public static function verify_webfinger_parameters() {
        return new external_function_parameters(
            array(
                'name' => new external_value(PARAM_RAW, 'The username that the user has given us', VALUE_REQUIRED),
                'domain' => new external_value(PARAM_RAW, 'The domain that the user has given us', VALUE_REQUIRED)
            )
        );
    }
