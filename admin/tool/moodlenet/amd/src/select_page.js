...
define([
     ...
     */
    var searchCourses = function searchCourses(inputValue, page, areaReplace) {
        ...
        Ajax.call([{
            ...
            if (result.courses.length === 0) {
                Templates.renderPix('courses', 'tool_moodlenet').then(function(img) {
                    return img;
                }).then(function(img) {
                    var temp = document.createElement('div');
                    temp.innerHTML = img.trim();
                    Templates.render('core_course/no-courses', {
                ...
                Templates.render('tool_moodlenet/view-cards', {
