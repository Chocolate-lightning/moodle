...
class tool_moodlenet_profile_manager_testcase extends advanced_testcase {
     ...
     */
    public function test_get_mnet_profile() {
        global $DB;
        $this->resetAfterTest();
        ...
        $result = \tool_moodlenet\profile_manager::get_mnet_profile($user->id);
    ...
    public function test_save_moodlenet_user_profile() {
        ...
        $profile = \tool_moodlenet\profile_manager::get_mnet_profile($user->id);
