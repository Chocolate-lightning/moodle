...
$requestorigin = required_param('origin', PARAM_RAW);
$requestorigin= urldecode($requestorigin);
...
// Dummy page.
echo $OUTPUT->header();
\core\notification::info("Importing the MoodleNet resource: " . $resourceurl . " from origin: " . $requestorigin);
echo $OUTPUT->footer();
