...
const tokenFiles = fs.readdirSync('public/theme/boost/src').filter((file) => file.endsWith('.json'));
// Configure Style Dictionary
const myStyleDictionary = new StyleDictionary({
    source: tokenFiles.map((file) => `public/theme/boost/src/${file}`),
    platforms: {
        scss: {
            transformGroup: 'scss',
            buildPath: 'public/theme/boost/scss/tokens/',
