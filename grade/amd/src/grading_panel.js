 ...
 *
 * @module     core_grades/grading_panel
 * @package    core_grades
 * @class      GradingPanel
...
define(['jquery', 'core/yui', 'core/notification', 'core/templates', 'core/fragment',
        'core/ajax', 'core/str', 'core_grades/grading_form_change_checker',
        'core_grades/grading_events', 'core/event'],
    ...
    GradingPanel.prototype._addPopoutButtons = function(selector) {
        ...
        templates.render('core_grades/popout_button', {}).done(function(html) {
    ...
    GradingPanel.prototype._refreshGradingPanel = function(event, userid, submissiondata, attemptnumber) {
        ...
        templates.render('core_grades/loading', {}).done(function(html, js) {
            // Update the page.
            this._niceReplaceNodeContents(this._region, html, js).done(function() {
                if (userid > 0) {
                    ...
                    fragment.loadFragment('core_grades', 'gradingpanel', contextid, params).done(function(html, js) {
