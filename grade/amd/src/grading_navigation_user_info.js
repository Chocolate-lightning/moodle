 ...
 *
 * @module     core_grades/grading_navigation_user_info
 * @package    core_grades
 * @class      UserInfo
...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates'], function($, notification, ajax, templates) {
    ...
    UserInfo.prototype._refreshUserInfo = function(event, userid) {
        ...
        templates.render('core_grades/loading', {}).done(function(html, js) {
            ...
            if (userid < 0) {
                // Render the template.
                templates.render('core_grades/grading_navigation_no_users', {}).done(function(html, js) {
            ...
            promise.done(function(context) {
                ...
                templates.render('core_grades/grading_navigation_user_summary', context).done(function(html, js) {
                    // Update the page.
                    if (userid == this._lastUserId) {
                        this._region.fadeOut("fast", function() {
                            templates.replaceNodeContents(this._region, html, js);
