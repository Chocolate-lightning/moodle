 ...
 *
 * @module     core_grades/participants_selector
...
define(['core/ajax', 'jquery', 'core/templates'], function(ajax, $, templates) {
    ...
    return /** @alias module:core_grades/participants_selector */ {
            ...
            ajax.call([{
                ...
                $.each(results, function(index, user) {
                    ...
                    if (show) {
                        ...
                        promises.push(templates.render('core_grades/list_participant_user_summary', ctx).then(function(html) {
