...
/**
 * Singleview report general functions
 *
 ...
 * @return string|null
 */
function gradereport_singleview_get_report_link(context_course $context, int $courseid, array $element, object $gpr, string $mode): ?string {
