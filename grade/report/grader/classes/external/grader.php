 ...
 */
class grader extends core_course_external {
    /**
     * Describes the parameters for get_users_in_report
     *
     * @return external_function_parameters
     */
    public static function get_users_in_report_parameters(): external_function_parameters {
     ...
     */
    protected static function get_users_in_report(int $courseid): array {
        global $PAGE;
        self::validate_parameters(
            self::get_users_in_report_parameters(),
            [
                'courseid' => $courseid,
            ]
        );
     ...
     */
    public static function get_users_in_report_returns(): external_single_structure {
