...
class provider_test extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences_single() {
        ...
        set_user_preference('grade_report_grader_collapsed_columns', 'email,phone', $user);
        ...
        $this->assertEquals('email,phone', $prefs->grade_report_grader_collapsed_columns->value);
    }
